...
export const asyncRoutes = [
    ...
    children: [
      {
        path: 'index',
        name: 'Role',
        component: () => import('@/views/up/role/index'),
        meta: { title: 'role' }
      }
    ]
  },
    ...
    children: [
      {
        path: 'index',
        name: 'System',
        component: () => import('@/views/up/system/index'),
        meta: { title: 'system' }
      }
    ]
  },
    ...
    children: [
      {
        path: 'index',
        name: 'Organization',
        component: () => import('@/views/up/organization/index'),
  ...
  },
  {
    ...
    children: [
      {
        path: 'https://github.com/yangma/fo',
        meta: { title: 'backendLink', icon: 'link' }
      }
    ]
  },
